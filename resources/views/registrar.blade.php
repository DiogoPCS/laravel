                ...
                <div class="card-body">
                    <form action={{route('criar-conta')}} method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="nome_completo" required style="background-color: #E5E5E5; border: 1px solid #7F7F7F;">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="senha" required style="background-color: #E5E5E5; border: 1px solid #7F7F7F;">
                        </div>
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label" style="color: #404040;">Confirmar Senha</label>
                            <input type="password" class="form-control" id="password_confirmation" name="confirmar_senha" required style="background-color: #E5E5E5; border: 1px solid #7F7F7F;">
                        </div>
                        <div class="d-grid">
