<div class="bg-dark text-light rounded h-100 d-flex flex-column w-100" 
    ...
    <a href="#" class="btn btn-sm bg-warning text-dark rounded-2 shadow-sm" 
       data-bs-toggle="modal" 
       data-bs-target="#modalEditarProduto-{{ $produto->id }}" 
       style="position: absolute; top: 8px; right: 8px; z-index: 10; opacity: 1;">
        <img src="{{ asset('images/edit.svg') }}" alt="Editar" style="width:18px; height:18px; filter: brightness(0);"> 
    </a>
