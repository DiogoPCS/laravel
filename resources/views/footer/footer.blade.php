        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 mb-3 mb-md-0">
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-start gap-4">
                    <div class="logo-shrink">
                        <img src="{{ asset('images/logo.svg') }}" width="140" alt="Logo Tatuí Games">
                    </div>
            ...
            <div class="col-12 col-md-6 text-center text-md-end">
                <div class="small text-white-50">
                    <p class="mb-1">Rua Quinze de Novembro, 404A, Centro, Tatuí - SP</p>
                    <p class="mb-1">CNPJ: 50.386.161/0001-33</p>
                    <p class="mb-0 fw-bold">&copy; 2025 Tatuí Games</p>
                </div>
            </div>
